...
mixin _$GenreModel {
 ...
 int get count; String get genre;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GenreModel&&(identical(other.count, count) || other.count == count)&&(identical(other.genre, genre) || other.genre == genre));
}
...
@override
String toString() {
  return 'GenreModel(count: $count, genre: $genre)';
}
...
/// Create a copy of GenreModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? count = null,Object? genre = null,}) {
...
class _GenreModel implements GenreModel {
   _GenreModel({this.count = 0, this.genre = ''});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GenreModel&&(identical(other.count, count) || other.count == count)&&(identical(other.genre, genre) || other.genre == genre));
}
...
/// Create a copy of GenreModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? count = null,Object? genre = null,}) {
